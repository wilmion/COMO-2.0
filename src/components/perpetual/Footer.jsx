...
const ValidationInput = ({id}) => {
    const [className , setClassName] = useState('formulario__checkbox__decoration');
    const onClick= () => {
    ...
    return (<div className={className} id={id} onClick={onClick} tabIndex="0"></div>)
};
const Footer = () => {
